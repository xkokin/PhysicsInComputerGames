...
float a, ysur, vy, ymax, tmax, vmax, sy; //ymax je najvyssia pointa objektu, sy je startova suradnica pre maticu
...
void obsluhaResize(int sirka, int vyska){
    ...
    else gluOrtho2D(-0.5*a, 0.5*a, -0.5*pomstr*a, 0.5*pomstr*a);
